...
public class CSDiaE extends JFrame {
    public JLabel lbTitle = new JLabel("Top 10 đĩa ít được quan tâm");
    public JTable table;
    public MoHinhBangDia mhBangDia;
    public KetNoiToiCoSoDuLieu kn;

    public CSDiaE() {
        setTitle("Top 10 đĩa ít được quan tâm");
        setSize(1200, 500);
        dungGiaoDien();
        setVisible(true);
        setResizable(false);
    ...
    public void dungGiaoDien() {
        ...
        ArrayList<Integer> dsMaDia = kn.xemTop10DiaBanE();
